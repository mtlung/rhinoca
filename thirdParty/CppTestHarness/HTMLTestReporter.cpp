...
void HTMLTestReporter::ReportFailure(char const* file, size_t const line, std::string const failure)
{
	std::stringstream msg;
	msg << file << "(" << (unsigned int)(line) << ") : " << failure;
...
void HTMLTestReporter::ReportSummary(size_t const testCount, size_t const failureCount)
{
	...
	os << "<p><em>";
	os << (unsigned int)(testCount) << " tests run.<br />\n";
	os << (unsigned int)(failureCount) << " failed.<br />\n";
	os << "</em></p>";
